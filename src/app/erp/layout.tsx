    ...
    <div className="flex min-h-screen flex-col md:flex-row bg-gray-50">
      <aside className="w-full md:w-64 bg-slate-900 text-white p-6 md:min-h-screen">
        ...
        <nav className="flex flex-col gap-2">
          ...
          <div className="h-px bg-slate-800 my-2" />
          <div className="px-2 py-1 text-[10px] font-black text-slate-500 uppercase tracking-widest italic">Inteligência</div>
          ...
          <Link href="/erp/curadoria/fontes" className="hover:bg-slate-800 p-2 rounded transition-colors text-slate-300 hover:text-white font-medium text-xs pl-8">Gerenciar Feeds</Link>
