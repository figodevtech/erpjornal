...
export default function AboutForm({ mediaKitId, data, onChange }: Props) {
  return (
    <div className="space-y-4">
      <div>
        <label className="mb-1.5 block text-sm font-semibold text-gray-900">Título</label>
        <input
          type="text"
          value={data.title || ""}
      ...
      <div>
        <label className="mb-1.5 block text-sm font-semibold text-gray-900">Conteúdo / Texto Descritivo</label>
        <textarea
          value={data.content || ""}
