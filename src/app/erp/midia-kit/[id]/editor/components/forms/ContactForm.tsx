...
export default function ContactForm({ data, onChange }: Props) {
  return (
    <div className="space-y-4">
      ...
      <div>
        <label className="mb-1.5 block text-sm font-semibold text-gray-700">Email Comercial</label>
        <input
          type="email"
          value={data.email || ""}
      ...
      <div>
        <label className="mb-1.5 block text-sm font-semibold text-gray-700">Telefone / WhatsApp</label>
        <input
          type="text"
          value={data.phone || ""}
      ...
      <div>
        <label className="mb-1.5 block text-sm font-semibold text-gray-700">Endereço Físico (Opcional)</label>
        <textarea
          value={data.address || ""}
      ...
      <div>
        <label className="mb-1.5 block text-sm font-semibold text-gray-700">Redes Sociais (Opcional)</label>
