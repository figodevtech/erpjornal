...
export default function HeroForm({ mediaKitId, data, onChange }: Props) {
  return (
    <div className="space-y-4">
      <div>
        <label className="mb-1.5 block text-sm font-semibold text-gray-700">Título Principal</label>
        <input
          type="text"
          value={data.title || ""}
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="mb-1.5 block text-sm font-semibold text-gray-700">Texto do Botão (CTA)</label>
          <input
            type="text"
            value={data.ctaText || ""}
        ...
        <div>
          <label className="mb-1.5 block text-sm font-semibold text-gray-700">Link do Botão (CTA)</label>
          <input
            type="text"
            value={data.ctaLink || ""}
