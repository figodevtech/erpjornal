...
export default function StatsForm({ data, onChange }: Props) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <label className="mb-1.5 block text-sm font-semibold text-gray-700">Título da Seção (Opcional)</label>
        <input
          type="text"
          value={data.title || ""}
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <label className="block text-sm font-semibold text-gray-700">Métricas</label>
          <button
            type="button"
            onClick={addItem}
