    ...
    <div className="relative" ref={menuRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-[100] border border-gray-200 animate-in fade-in zoom-in duration-200">
          ...
          <SignOutButton className="flex w-full items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-red-700 transition-colors font-bold border-t border-gray-100" />
        </div>
      )}
    </div>
  );
