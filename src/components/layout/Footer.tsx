        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="col-span-1 md:col-span-5">
            <Link href="/" className="flex items-center gap-3 mb-6 group outline-none focus-visible:ring-2 focus-visible:ring-red-700/50 rounded-lg p-1" aria-label="Revista Gestão - Início">
              <div className="w-10 h-10 bg-red-700 text-white flex items-center justify-center font-black text-xl tracking-tighter" aria-hidden="true">
                RG
              </div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-gray-800 flex items-center justify-center hover:bg-red-700 transition-colors rounded-sm text-white focus-visible:ring-2 focus-visible:ring-red-700 outline-none">
